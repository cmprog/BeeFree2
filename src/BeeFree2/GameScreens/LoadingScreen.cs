...
namespace BeeFree2.GameScreens
{
    ...
    class LoadingScreen : GameScreen
    {
        ...
        public override void Activate(bool instancePreserved)
        {
            ...
            this.mFont = this.ScreenManager.Game.Content.Load<SpriteFont>("Fonts/loadingfont");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                Vector2 textSize = this.mFont.MeasureString(message);
                ...
                // Draw the text.
                spriteBatch.Begin();
                spriteBatch.DrawString(this.mFont, message, textPosition, color);
                spriteBatch.End();
            }
        }
