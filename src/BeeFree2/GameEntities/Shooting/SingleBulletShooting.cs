...
{
    /// <summary>
    /// This class shoots single bullets in line with the orientation of the entity
    /// with a configurable speed, fire rate, and damage.
    /// </summary>
    internal class SingleBulletShooting : IShootingBehavior
    {
        /// <summary>
